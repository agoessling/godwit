...
#define ST7529_VOLCTRL_PARAM0   0x18    // Vop = 14.8V
#define ST7529_VOLCTRL_PARAM1   0x04    // Vop = 14.8V
...
#define ST7529_D07_PORTA_PINS   ((1<<ST7529_D0_PIN)|(1<<ST7529_D1_PIN)\
                                |(1<<ST7529_D1_PIN)|(1<<ST7529_D1_PIN)\
                                |(1<<ST7529_D1_PIN)|(1<<ST7529_D1_PIN)\
                                |(1<<ST7529_D1_PIN)|(1<<ST7529_D1_PIN)\
                                &0xFFFFFFFF)

#define ST7529_D07_PORTB_PINS  (((1<<ST7529_D0_PIN)>>5)|((1<<ST7529_D1_PIN)>>5)\
                                |((1<<ST7529_D1_PIN)>>5)|(1<<ST7529_D1_PIN>>5)\
                                |((1<<ST7529_D1_PIN)>>5)|(1<<ST7529_D1_PIN>>5)\
                                |((1<<ST7529_D1_PIN)>>5)|(1<<ST7529_D1_PIN>>5)\
                                &0xFFFFFFFF)
